...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
    ...
    let AIRYZON_APP_ID                       = "5920086965e99"
    let AIRYZON_API_KEY                      = "121b078c0b324860d916f4c10d6dc96ebc4885035ea6fbd75f78de5a3d9f8c41"
    ...
    //MARK:- Notification
    @objc func handleNotificationForBleDisconnected() -> Void
    {
        //建立UIAlertController
    ...
    @objc func scanDevice()
    {
        ...
        BeaconAPI.sharedInstance.scanBeacon(Timer: 4.0, { (state:BeaconAPI.ScanState) -> Void in
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        //cell.m_pLblTemperature.text = "\(beacon.m_fTemperature)ºC"
